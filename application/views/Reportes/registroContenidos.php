    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url(); ?>/Reportes/registroContenidos">Formulario</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
                <li class="nav-item">
                    <a href="<?php echo site_url(); ?>/Reportes/reporteGeneral">Base de datos Recorrido</a>
                </li>
            </ul>
        </div>
                ...
                <div class="card">
                    ...
                    <form action="<?php echo site_url('Empleados/guardarDatos'); ?>" id="frm_registrar_contenedor" method="post">
                        ...
                        <div class="card-action text-center">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <button class="btn btn-danger" type="button" href="<?php echo site_url(); ?>/Inicios/login"><b>SALIR</b></button>
                        </div>
                    </form>
